...
resource "azurerm_subnet" "vnet2-sub4" {
...
resource "azurerm_route_server" "route-server" {
  ...
  subnet_id           = azurerm_subnet.vnet2-sub4.id
  public_ip_address_id = azurerm_public_ip.route-server-pip.id
  sku = "Standard"  # SKU for the Route Server
}
...
resource "azurerm_virtual_network_peering" "vnet2-to-vnet4" {
  name                      = "vnet2-to-vnet4"
  resource_group_name       = azurerm_resource_group.rg-we.name
  virtual_network_name      = azurerm_virtual_network.vnet2.name
...
resource "azurerm_virtual_network_peering" "vnet4-to-vnet2" {
  name                      = "vnet4-to-vnet2"
  resource_group_name       = azurerm_resource_group.rg-we.name
  virtual_network_name      = azurerm_virtual_network.vnet4.name
  remote_virtual_network_id = azurerm_virtual_network.vnet2.id
  depends_on = [azurerm_virtual_network_peering.vnet2-to-vnet4]
}

resource "azurerm_virtual_network_peering" "vnet3-to-vnet5" {
  name                      = "vnet3-to-vnet5"
  resource_group_name       = azurerm_resource_group.rg-we.name
  virtual_network_name      = azurerm_virtual_network.vnet3.name
...
resource "azurerm_virtual_network_peering" "vnet5-to-vnet3" {
  name                      = "vnet5-to-vnet3"
  resource_group_name       = azurerm_resource_group.rg-we.name
  virtual_network_name      = azurerm_virtual_network.vnet5.name
  remote_virtual_network_id = azurerm_virtual_network.vnet3.id
  depends_on = [azurerm_virtual_network_peering.vnet3-to-vnet5]
}
